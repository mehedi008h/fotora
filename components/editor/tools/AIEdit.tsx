...
export function AIEdit({ project }: AIEditProps) {
    ...
    const buildRetouchUrl = (imageUrl: any, presetKey: any) => {
    ...
    const applyRetouch = async () => {
        ...
        setProcessingMessage(
            `Enhancing image with ${selectedPresetData.label}...`
        );

        try {
            const currentImageUrl =
                mainImage.getSrc?.() ||
                mainImage._element?.src ||
                mainImage.src;
            const retouchedUrl = buildRetouchUrl(
                currentImageUrl,
                selectedPreset
            );
                ...
                <div className="flex items-start gap-3">
                    ...
                    <div>
                        ...
                        <p className="text-amber-300/80 text-sm">
                            Please add an image to the canvas first to use AI
                            retouching.
                        </p>
                    </div>
                </div>
        ...
        <div className="space-y-6">
            ...
            <div className="bg-slate-700/30 rounded-lg p-4">
                ...
                <div className="space-y-2 text-xs text-white/70">
                    <p>
                        • <strong>AI Retouch:</strong> AI analyzes and applies
                        optimal improvements
                    </p>
                    <p>
                        • <strong>Smart Processing:</strong> Preserves details
                        while enhancing quality
                    </p>
                    <p>
                        • <strong>Multiple Styles:</strong> Choose enhancement
                        that fits your image
                    </p>
                    <p>
                        • <strong>Instant Results:</strong> See improvements in
                        seconds
                    </p>
                </div>
            </div>
